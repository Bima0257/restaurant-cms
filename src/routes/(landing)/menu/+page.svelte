...
<div class="pt-24 pb-12 md:pt-32 md:pb-20 px-gutter max-w-grid-max-width mx-auto">
  <!-- Header -->
  <div class="mb-10">
    <h1 class="font-headline-h1 text-headline-h1 text-ivory-white mb-3">
      Our <span class="text-flame-orange">Menu</span>
    </h1>
    <p class="text-muted-gray text-body-lg max-w-2xl">
      Explore our curated selection of premium dishes crafted with the finest ingredients from around the world.
    </p>
  </div>
