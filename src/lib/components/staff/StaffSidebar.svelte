...
<aside class="w-64 bg-surface-card border-r border-deep-border flex flex-col h-screen sticky top-0">
  <div class="p-6 border-b border-deep-border">
    <a href="/staff/orders" class="font-headline-h3 text-headline-h3 text-flame-orange font-extrabold">WorldPlate</a>
    <p class="text-muted-gray text-xs mt-1">Staff Panel</p>
  </div>

  <nav class="flex-1 p-4">
    <p class="text-muted-gray text-[10px] font-semibold uppercase tracking-wider px-3 mb-1">Operations</p>
